...
import { CustomHeader, SidebarHeader, Timeline, TimelineHeaders } from 'react-calendar-timeline';
        ...
        <>
            <Flex gap={'middle'} className={cx.container}>
                ...
                <div className={cx.hotelInfo}>
                    <HotelImage type={hotel?.type} className={cx.hotelIcon} src={hotelImage.src} width={157} height={164} onClick={() => (onHotelClick ? onHotelClick(hotel?.id) : undefined)} />
                    <div className={cx.stars}>
                        <HotelRating rating={rating} />
                    </div>
                    <div className={cx.hotelDescription}>
                        <HotelTitle className={cx.hotelTitle} onClick={() => (onHotelClick ? onHotelClick(hotel?.id) : undefined)}>
                            {hotel?.title}
                        </HotelTitle>
