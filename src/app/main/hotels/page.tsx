...
export default function Hotels() {
    ...
    const PAGE_SIZE = 6;
    const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading, error, refetch } = useInfiniteHotelsQuery(undefined, PAGE_SIZE, true);
    ...
    useEffect(() => {
        ...
        if (lastItem && (lastItem.index + 1) * columnCount >= hotels.length && hasNextPage && !isFetchingNextPage && hotels.length > 0) {
            fetchNextPage();
        }
